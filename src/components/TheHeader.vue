<template>
  <header class="flex p-3 justify-between bg-gradient-to-r from-slate-800 to-gray-600 items-center sticky top-0">
    ...
    <div v-show="!mobileNavOpen" class="" @click="mobileNavOpen = true">
      <svg
        xmlns="http://www.w3.org/2000/svg"
  ...
  <transition enter-active-class="animate__animated animate__slideInRight animate__faster">
    <nav
      ...
      class="flex flex-col space-y-3 items-end bg-gray-200 p-4 rounded-lg m-1 shadow-lg fixed right-1 top-1"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
